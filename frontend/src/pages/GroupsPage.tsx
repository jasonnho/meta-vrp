        ...
        return (
            <div className="rounded-md border">
                <Table>
                    ...
                    <TableCaption>
                        Menampilkan {filteredGroups.length} dari total{" "}
                        {groups.length} grup.
                    </TableCaption>
                </Table>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    {isFetching && !isLoading && (
                        <Badge
                            variant="outline"
                            className="gap-1.5 py-1.5 hidden sm:flex"
                        >
                            {" "}
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                if (deletingGroup)
                                    remove.mutate(deletingGroup.id);
                            }}
