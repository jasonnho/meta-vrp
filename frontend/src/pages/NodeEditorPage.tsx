    ...
    return (
        <div className="p-4 space-y-4">
            ...
            <p className="text-muted-foreground">
                Solusi ini tidak menyimpan ke database. Anda harus copy-paste
                JSON secara manual.
            </p>
                                ...
                                return (
                                    <CircleMarker
                                        ...
                                        pathOptions={{
                                            color: isSelected
                                                ? "#1d4ed8"
                                                : "#16a34a", // Biru jika terpilih
                                            fillColor: isSelected
                                                ? "#1d4ed8"
                                                : "#22c55e", // Hijau default
                                            fillOpacity: 0.8,
                                        }}
                    ...
                    <CardHeader>
                        ...
                        <CardDescription>
                            ...
                            <code className="bg-muted px-1 rounded-sm">
                                frontend/src/data/nodes.data.ts
                            </code>
                            , cari node{" "}
                            <code className="bg-muted px-1 rounded-sm">
                                {selectedNode?.name ?? "..."}
                            </code>
                            , dan paste JSON ini ke field{" "}
                            <code className="bg-muted px-1 rounded-sm">
                                geometry
                            </code>
                            .
