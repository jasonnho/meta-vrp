...
export default function StatusPage() {
    ...
    const stepKey = (vid: string | number, seq: number | string) =>
        `${vid}:${seq}`;
                ...
                >
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Pilih job untuk memantau dan memperbarui status
                            kendaraan serta progres rute.
                        </p>
                    </div>
                    <motion.div
                ...
                <motion.div {...fadeUp}>
                    <Card className="transition-shadow">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Pilih job yang sedang berjalan atau terencana
                                untuk di-update.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-3">
                            ...
                            {selectedJobId && loadingDetail && (
                                <Alert className="bg-muted/50">
                                    ...
                                    <AlertDescription>
                                        Sedang mengambil data kendaraan dan rute
                                        untuk Job ID: {selectedJobId}
                                    </AlertDescription>
                                </Alert>
                            )}
                            {jobErr && (
                        ...
                        <motion.div {...fadeUp}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Klik pada kendaraan untuk melihat dan
                                        mengubah status rutenya.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="p-0">
                                    {vehicles.length === 0 ? (
                                        ...
                                        >
                                            ...
                                            <p className="text-sm">
                                                Job ini tidak memiliki alokasi
                                                kendaraan.
                                            </p>
                                        </motion.div>
                                    ) : (
